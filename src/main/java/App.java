...
public class App {
    ...
    private static void startChatting(){
        ...
        serverActor.tell(new MessagingServer.ConnectUser(username, userActor), userActor);
        ...
        while (true) {
            ...
            serverActor.tell(new MessagingServer.SendMessage(username, recipient, message), userActor);

            if (message.equals("back")) {
                serverActor.tell(new MessagingServer.DisconnectUser(username, userActor), userActor);
                break;
            }
        }
    }
